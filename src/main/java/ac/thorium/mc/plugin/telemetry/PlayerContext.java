...
public final class PlayerContext {
    ...
    /** What the player is riding, lower-cased; empty when they are not. */
    ...
    private PlayerContext(Builder b) {
        gamemode = b.gamemode; dimension = b.dimension; world = b.world; vehicleType = b.vehicleType; pingMs = b.pingMs; tps = b.tps;
    ...
    public static final class Builder {
        private int gamemode; private String dimension = ""; private String world = ""; private String vehicleType = ""; private int pingMs; private double tps = 20.0;
        ...
        public Builder vehicleType(String v) { vehicleType = v == null ? "" : v.toLowerCase(java.util.Locale.ROOT); return this; }
